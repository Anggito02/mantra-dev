...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        # self.preprojection = nn.Linear(1, self.num_models, bias=True)
        ...
        print("urt_heads: " + str(configs.urt_heads))
        ...
        # self.URT_model  = MultiHeadURT(key_dim=self.flat_dim, query_dim=configs.batch_size*self.flat_dim, hid_dim=1024, temp=1, att="cosine", n_head=1)
        self.URT_model  = MultiHeadURT(key_dim=configs.pred_len , query_dim=configs.pred_len*configs.enc_in, hid_dim=4096, temp=1, att="cosine", n_head=configs.urt_heads)
