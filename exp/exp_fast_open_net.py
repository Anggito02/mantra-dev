...
class Exp_OpenNet_Fast(Exp_Basic):
    def __init__(self, args):
        super(Exp_OpenNet_Fast, self).__init__(args)
    ...
    def train(self, setting):
        ...
        best_model_path = path + '/' + f'checkpoint_fast_{self.args.model_idx}_{self.args.model}.pth'
